                    ...
                    <div class="">
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-600 text-sm font-bold mb-2">Name</label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                class="block text-gray-600 text-sm font-bold mb-2">Email:</label>
                            <textarea
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                class="block text-gray-600 text-sm font-bold mb-2">Mobile:</label>
                            <textarea
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput2" wire:model="mobile"
                                placeholder="Enter Mobile"></textarea>
                            @error('mobile') <span class="text-red-700">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
